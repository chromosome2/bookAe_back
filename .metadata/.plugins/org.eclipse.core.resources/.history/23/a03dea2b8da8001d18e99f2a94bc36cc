    ...
    <div id="wrapper">
        ...
        <div id="contentsArea">
            ...
            <div class="overflowImage">
                <img id="whasalL" src="images/whasal1.png" alt="ImageBannerPrev">
                <img id="whasalR" src="images/whasal2.png" alt="ImageBannerNext">
                <div class="imageBanner">
                    ...
                    <img class="page1" src="images/banner5.png" alt="banner5">
                </div>
            </div>
            <!--베스트셀러-->
                ...
                <section id="BSday">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_1">1</p>
                                <img src="images/day1.jpg" alt="1등, 피라네시">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_2">2</p>
                                <img src="images/day2.jpg" alt="2등, 스토아적 삶의 권유">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_3">3</p>
                                <img src="images/day3.jpg" alt="3등, 음식을 처방해 드립니다">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#" class="etc">
                                <p class="rank">4</p>
                                <img src="images/day4week1month4.jpg" alt="4등, 기특한 나">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#" class="etc">
                                <p class="rank">5</p>
                                <img src="images/day5week2.jpg" alt="5등, 시간을 찾아드립니다">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                ...
                <section id="BSweek">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_1">1</p>
                                <img src="images/day4week1month4.jpg" alt="1등, 기특한 나">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_2">2</p>
                                <img src="images/day5week2.jpg" alt="2등, 시간을 찾아드립니다">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_3">3</p>
                                <img src="images/week3.jpg" alt="3등, 150년 하버드 글쓰기 비법">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#" class="etc">
                                <p class="rank">4</p>
                                <img src="images/week4month3.jpg" alt="4등, 심리 읽어드립니다">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#" class="etc">
                                <p class="rank">5</p>
                                <img src="images/week5month1.jpg" alt="5등, 나는 왜 혼자가 편할까?">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                ...
                <section id="BSmonth">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_1">1</p>
                                <img src="images/week5month1.jpg" alt="1등, 나는 왜 혼자가 편할까?">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_2">2</p>
                                <img src="images/month2.jpg" alt="2등, 마음의 법칙">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#">
                                <p class="rank_3">3</p>
                                <img src="images/week4month3.jpg" alt="3등, 심리 읽어드립니다">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
                        ...
                        <li>
                            <a href="#" class="etc">
                                <p class="rank">5</p>
                                <img src="images/month5.jpg" alt="5등, 편애하는 문장들">
                                <div class="box">
                                    <div class="plus">
                                        <div></div>
                                        <p>보러가기</p>
            ...
            <div id="magazineBanner">
                ...
                <ul>
                    <li>
                        <div>
                            <a href="#"><img src="images/magazine1.jpg" alt="작가 이미예"></a>
                            <span>&lt;인터뷰&gt;</span>
                    ...
                    <li>
                        <div>
                            <a href="#"><img src="images/magazine2.png" alt="책 읽는 서울 광장"></a>
                            <span>&lt;행사&gt;</span>
                    ...
                    <li>
                        <div>
                            <a href="#"><img src="images/magazine3.jpg" alt="서울 국제도서전 포스터"></a>
                            <span>&lt;뉴스&gt;</span>
            ...
            <div id="choice">
                <section class="bookaeChoice">
                    <h2>북애의 선택</h2>
                    <img src="images/choice1.jpg" alt="벚꽃지는 계절에 그대를 그리워하네 표지">
                    <div class="naeyong">
                        <div class="naeCenter">
                ...
                <section class="celebrityChoice">
                    ...
                    <img src="images/choice2.jpg" alt="팍스 표지">
                    <div class="naeyong">
                        <div class="naeCenter">
                            <h3>『팍스』</h3>
