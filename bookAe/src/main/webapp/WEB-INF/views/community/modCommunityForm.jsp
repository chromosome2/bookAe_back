...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			//장르 selected 만들기
			var selectedGenre='<c:out value="${board.board_genre}"/>';
			$('#board_genre').val(selectedGenre).prop("selected",true);
    ...
    <div id="wrapper">
        ...
        <div class="communityMenu">
            ...
            <section id="content_section">
            	<form action="${contextPath }/community/modArticle.do" method="post" id="writeArticleForm" name="modArticleForm">
